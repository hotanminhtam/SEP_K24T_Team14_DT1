...
namespace WebsiteRegisteredLearningPlan.Areas.QuanLy.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        // GET: QuanLy/AspNetUsers/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: QuanLy/AspNetUsers/Create
        ...
        // POST: QuanLy/AspNetUsers/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: QuanLy/AspNetUsers/Delete/5
        ...
        // POST: QuanLy/AspNetUsers/Delete/5
